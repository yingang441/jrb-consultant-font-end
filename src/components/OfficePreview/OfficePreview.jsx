  ...
  render() {
      ...
      return (
        <div className="officepreview-container" style={{borderRadius: 30}}>
          ...
          <Link to="/admin/companies" style={{width: 100}} className="d-flex ml-auto mr-3 mb-3 jrb-button hv-jrb-green px-1 d-flex align-items-center justify-content-center px-3 py-2" md="4">
