...
class OfficeChart extends React.Component {
  render() {
      ...
      return (
        <div className="officechart-container">
          ...
          <Link to="/admin/tasks" style={{width: 100}} className="btn-report d-flex ml-auto mr-0 mb-3 jrb-button hv-jrb-green px-1 d-flex align-items-center justify-content-center px-3 py-2" md="4">
